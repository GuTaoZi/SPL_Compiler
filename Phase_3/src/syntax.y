%{
    ...
    void print_B_error(TN node_name, const size_t lineno, const char *msg)
    {
...
StmtList :                      { add0($$, StmtList); }
    ...
    | Stmt Def DefList StmtList { add0($$, INVALID); has_error = 1; print_B_error(StmtList, $1->lineno, "Missing specifier"); }
    ;
